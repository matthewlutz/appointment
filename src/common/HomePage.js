            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
                <div className="mt-12 md:flex md:justify-center md:space-x-10 md:items-center">
                    <div className="md:w-1/2 text-center p-6">
                        ...
                        <Link to="/userLogin" className="inline-block bg-blue-800 hover:bg-blue-900 text-white font-bold py-3 px-6 rounded-full transition duration-300 ease-in-out">Get Started</Link>
                    </div>
                    ...
                    <div className="md:w-1/2 text-center p-6 mt-10 md:mt-0">
                        ...
                        <Link to="/serviceLogin" className="inline-block bg-green-700 hover:bg-green-800 text-white font-bold py-3 px-6 rounded-full transition duration-300 ease-in-out">Join Us</Link>
                    </div>
                </div>
            </div>
        </div>
